...
export default function ExpenseAdd() {
  const { budget, group, expenseCategory } = useGetData();
  ...
  const optionsEspense = expenseCategory.map((item) => {
    return {
      value: item.id,
      label: item.name
    }
      ...
      <MainLayout>
        <div className="p-8 w-full h-full ">
          <div className="flex justify-between">
            <div>
                <h1 className="text-2xl font-bold">Зарлага нэмэх</h1>
            </div>
          ...
          <div className="mt-8 mx-[20%] flex flex-col gap-4">
            ...
            <div className="flex gap-8">
                ...
                <Select className="w-full" id="category" options={optionsEspense} defaultValue={category} onChange={onChangeCategory}/>
            </div>
